...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Sofi-Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['Sofi-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './SofiJadiBot';
if (!existsSync(subBotDirectory)) {
console.log('🤍 Sofi-Bot no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'SofiSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🤍 Ai Sofi conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🤍 Error al iniciar Sofi-Bot: `, error))
}
})();
