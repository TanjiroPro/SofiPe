...
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packname = '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁'
global.author = '@yallico.owner'
global.wm = '𝗠𝗶𝗰𝗸𝗲𝘆 𝗜𝗔'
global.titulowm = '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁 🦦'
global.titulowm2 = '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁 🦦'
global.igfg = '@yallico.owner'
global.botname = '𝗠𝗶𝗰𝗸𝗲𝘆 𝗕𝗼𝘁 🦦'
global.dev = '`𝗠𝗶𝗰𝗸𝗲𝘆 𝗕𝗼𝘁 🦦`\n*By • Titanium Team 💥*'
global.titu = '*[ By : Mickey x Yallico ]*'
global.textbot = 'Mickey Bot X Yallico 🤍'
global.vs = '1.5.1'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Mickey Bot-MD', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𖥔.𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨❞ ꔷ──᜔◇⃟̣̣⃕✨', jpegThumbnail: logo7 }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁 🦦', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖S O F I  B O T 🦦', jpegThumbnail: logo8 }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁 🦦', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𝐒𝐭𝐢𝐜𝐤𝐞𝐫 (^_^♪) 💥', jpegThumbnail: logo8 }}};

global.estilox = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗦𝗼𝗳𝗶 𝗕𝗼𝘁 🦦', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}


//• ↳ ◜𝑳𝑰𝑵𝑲𝑺◞ • 🌿
global.id_canal = '120363330969414495@newsletter' //-ID de canal de WhatsApp
global.canal = 'https://www.instagram.com/maybesofia3' //CANAL GENESIS
global.canal2 = 'https://www.instagram.com/maybesofia3' //CANAL TITANIUM TEAM
global.bgp = 'https://www.instagram.com/maybesofia3' //GRUPO DE AVISOS
global.bgp2 = 'https://www.instagram.com/maybesofia3' //GRUPO GLOBAL 1
global.bgp3 = 'https://www.instagram.com/maybesofia3' //GRUPO GLOBAL 2
global.bgp4 = 'https://www.instagram.com/maybesofia3' //GRUPO NSFW
global.md = 'https://www.instagram.com/maybesofia3' //Github Oficial
global.ig = 'https://www.instagram.com/maybesofia3' //Ig Oficial
