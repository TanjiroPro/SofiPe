...
const defaultMenu = {
  before: `╔════════════════╗
┇➤ Hola \`%name\` soy Sofi Bot 🦦, %greeting
╚════════════════╝
...
┇
┇➤ _\`Nombre\`_ :: %name
┇➤ _\`Mi Creador\`_ :: Yallico Owner
┇➤ _\`Modo\`_ :: Publico
┇➤ _\`Tiempo Activo\`_ :: %muptime
┇➤ _\`Grupo Ventas\`_ :: https://chat.whatsapp.com/Job5huGBApuHJAL9kmOG7i
╚════════════════╝
`.trimStart(),
  header: '╔══ _\`%category\`_ ══╗',
  body: '┇➤ %cmd\n',
  footer: '╚═══════════════╝\n',
  after: `> By Sofi Baby Bot`,
}
let ppp = 'https://qu.ax/CyeAN.jpg'
